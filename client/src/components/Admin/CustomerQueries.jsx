          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none"
              />
            </div>
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500 outline-none"
              >
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="px-3 py-2 text-pink-600 hover:bg-pink-50 rounded-lg transition-colors flex gap-3 items-center"
                          >
                            <FaEye /> View Details
                          </button>
                        </div>
